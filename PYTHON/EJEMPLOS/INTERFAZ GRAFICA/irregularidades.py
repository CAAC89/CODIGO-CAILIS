...
def ejecutar(f): v0.after(200,f) # Una forma alternativa de ejecutar una funci?n

v0.config(bg="black") # Le da color al fondo
v0.geometry("500x500") # Cambia el tama?o de la ventana

b1=Button(v0,text="ABRIR VENTANA V1",command=lambda: ejecutar(mostrar(v1))) # Primer bot?n
